...
type FooterIndexQuery = { readonly site: { readonly siteMetadata: { readonly author: string | null } | null } | null };

type HeaderIndexQueryVariables = Exact<{ [key: string]: never; }>;


type HeaderIndexQuery = { readonly site: { readonly siteMetadata: { readonly title: string | null } | null } | null };
...
type PostTemplateQueryQuery = { readonly markdownRemark: { readonly id: string, readonly html: string | null, readonly frontmatter: { readonly title: string | null, readonly date: string | null, readonly tags: ReadonlyArray<string | null> | null } | null } | null };
...
type PostPagesQueryQuery = { readonly articles: { readonly edges: ReadonlyArray<{ readonly node: { readonly id: string, readonly frontmatter: { readonly slug: string | null, readonly tags: ReadonlyArray<string | null> | null } | null } }> } };

type TagPagesQueryQueryVariables = Exact<{ [key: string]: never; }>;


type TagPagesQueryQuery = { readonly tags: { readonly distinct: ReadonlyArray<string> } };
